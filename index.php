<?php
    ...
    $conn = mysqli_connect("localhost", "saiaditya", "1234", "project");

    // Destroy if not possible to create a connection
    if(!$conn){
        echo "<h3 class='container bg-dark p-3 text-center text-warning rounded-lg mt-5'>Not hfhfable to establish Database Connection<h3>";
    }
